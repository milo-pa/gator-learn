      ...
      <main className="form-main">
        <form className="form" onSubmit={handleSubmit(onSubmit)}>
          ...
          <div className="form-row">
            ...
            {submitCount > 0 && errors.name && <div className="error-text desc-text">{errors.name.message}</div>}
          </div>
          ...
          <div className="form-row">
            ...
            <div className={"input-wrapper"}>
              <input type="file" id="profile-photo" accept="image/jpeg, image/png, image/webp" {...register("photo")} />
            </div>
