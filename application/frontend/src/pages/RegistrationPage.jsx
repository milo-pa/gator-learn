...
function RegistrationPage() {
    ...
    const onSubmit = (data) => {
        ...
        formData.append("name", cleanText(data.name));
        formData.append("email", cleanText(data.email).toLowerCase());
        formData.append("password", data.password);
        formData.append("photoFile", data.photo[0]);
        formData.append("description", cleanFreeText(data.description));
        formData.append("pronouns", cleanText(data.pronouns));
        ...
        userAccountService
            ...
            .catch((err) => {
                ...
                alert(`Registration failed with status ${status}.`);
            });
        ...
        <div className="form-page registration-page">
            ...
            <main className="form-main">
              ...
              ${submitCount > 0 && errors.name ? "input-error" : ""}`}
                    ...
                    {/* School Email */}
                    <div className="form-row">
                        <label htmlFor="school-email" className="required-label">
                            SFSU Email:
                        </label>
                        <div
                            className={`input-wrapper 
              ...
              ${submitCount > 0 && errors.password ? "input-error" : ""}`}
                    ...
                    {/* Confirm Password */}
                    <div className="form-row">
                        <label htmlFor="confirm-password" className="required-label">
                            Confirm Password:
                        </label>
                        <div
                            className={`input-wrapper password-wrapper
                ${submitCount > 0 && errors.confirmPassword ? "input-error" : ""}`}
                    ...
                    <div className={"form-row"}>
                        ...
                        <div className={"input-wrapper small-input-wrapper"}>
                            <input id="name" placeholder="She/Her" />
                        </div>
                    ...
                    <div className="form-row">
                        ...
                        {submitCount > 0 && errors.terms && (
                            <div className="error-text desc-text">{errors.terms.message}</div>
                        )}
                    </div>
